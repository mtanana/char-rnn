...
Update:  always use -track 0   
(This disables my custom model tracker...if anyone wants the tomcat webapp to do use this tracker, let me know)

Note:  you should do your preprocessing before bringing it into this program.  I space out all of my punctuation so that periods, quotes, commas, etc are just recognized as words in the vocab.  Soon, I'll try and add a way to control the vocab size in this program.
